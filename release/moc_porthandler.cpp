...
#include "../MotoricaStendInterface/porthandler.h"
...
QT_MOC_LITERAL(1, 12, 7), // "dataGet"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 7) // "process"

    },
    "Porthandler\0dataGet\0\0process"
};
...
void Porthandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Porthandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Porthandler::dataGet)) {
                *result = 0;
                return;
            }
        }
